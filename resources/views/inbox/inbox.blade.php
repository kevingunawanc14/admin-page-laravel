                        ...
                        @foreach ($inbox as $data)
                            <tr class="{{ $data->status == '1' ? '' : 'backgroundBaris' }}">
                                ...
                                <td>
                                    ...
                                    @if ($data->status == '1')
                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Inbox" href=""
                                            onclick="updateAndNavigate({{ $data->id }})" type="button"
                                            class="btn btn-info"><i class="ri-mail-line"></i></a>
                                    @else
                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Inbox" href=""
                                            onclick="updateAndNavigate({{ $data->id }})" type="button"
                                            class="btn btn-info"><i class="ri-mail-open-line"></i></a>
                                    @endif
                                    <a data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"
                                        href="{{ route('deleteInbox', $data->id) }}"
